...
//        [[SDWebImageManager sharedManager] downloadImageWithURL:photo.url options:SDWebImageCacheMemoryOnly progress:nil completed:nil];
         SDWebImageManager *manager = [SDWebImageManager sharedManager];
        [manager downloadImageWithURL:photo.url options:SDWebImageRetryFailed progress:^(NSInteger receivedSize, NSInteger expectedSize){
