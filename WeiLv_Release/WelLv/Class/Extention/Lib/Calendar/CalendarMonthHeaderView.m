...
#define CATDayLabelWidth    windowContentWidth/8
...
- (void)setup
{
    ...
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.f, 10.0f, windowContentWidth-20, 30.f)];
    ...
    NSLog(@"%f,%f",CATDayLabelWidth,xOffset);
    ...
    xOffset += CATDayLabelWidth + CATDayLabelWidth/7;
