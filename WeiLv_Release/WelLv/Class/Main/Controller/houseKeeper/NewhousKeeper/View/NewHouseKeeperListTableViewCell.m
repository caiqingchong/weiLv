...
-(void)setHouseKeeperListModel:(NewHosekeeperListModel *)houseKeeperListModel{
    ...
    [self.avatarImage sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/%@",WLHTTP,self.houseKeeperListModel.avatar]] placeholderImage:[UIImage imageNamed:@"默认图1"]];
