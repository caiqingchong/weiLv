...
- (void)loadDataPage:(NSInteger )page count:(NSInteger)count
{
    ...
    [_afMangerl POST:imagStr parameters:postDict success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        //[self.personNameArr removeAllObjects];
...
-(void)setupTitleView
{
    ...
    self.baseScrollView.contentSize = CGSizeMake(windowContentWidth, self.baseScrollView.frame.size.height+128);
    ...
    {
    self.baseScrollView.contentSize = CGSizeMake(windowContentWidth, self.baseScrollView.frame.size.height+24);
...
-(void)setupMiddleView
{
    ...
    self.midellView = [[UIView alloc]init];
    if (IS_IPHONE_4_OR_LESS) {
        
        self.midellView.frame =CGRectMake(0,self.titleView.frame.origin.y+self.titleView.frame.size.height, windowContentWidth, 260);
    ...
    {
       self.midellView.frame =CGRectMake(0,self.titleView.frame.origin.y+self.titleView.frame.size.height, windowContentWidth, 280);
        
    }else if (IS_IPHONE_6P)
    {
       self.midellView.frame =CGRectMake(0,self.titleView.frame.origin.y+self.titleView.frame.size.height, windowContentWidth, 300);
    }
