...
@interface JYCpaysucessVC ()
{
    UIScrollView *_scrollView;
}
@end

@implementation JYCpaysucessVC
...
- (void)initView
{
    ...
    productLable.titleLable.text = @"店家名称:";
    ...
    dateLable.titleLable.text = @"到店日期:";
    ...
    YXAutoEditVIew *numberLable = [[YXAutoEditVIew alloc] initWithFrame:CGRectMake(0,ViewY(dateLable)+ViewHeight(dateLable),windowContentWidth , 40)];
    numberLable.titleLable.text = @"就餐人数:";
