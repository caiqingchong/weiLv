//
//  ChangeTravellerInfoViewController.h
//  WelLv
//
...
typedef void (^changTravelerInfoBlock)(NSDictionary *personInfoDic);

@interface ChangeTravellerInfoViewController : XCSuperObjectViewController<UITextFieldDelegate,UIPickerViewDelegate,UIPickerViewDataSource>{
    UIButton *zjButton ;
    // UIView *bgChoiceView;
    NSArray *titArray;
...
@property (nonatomic, strong) changTravelerInfoBlock changTravelerInfoBlock;
