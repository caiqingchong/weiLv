...
@implementation OrderTZTableViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        UIView * lowvc = [[UIView alloc] initWithFrame:CGRectMake(0, 120, windowContentWidth, 20)];
        lowvc.backgroundColor = [UIColor whiteColor];
        [self addSubview:lowvc];
        [self addSubview:bgView];
                ...
                _catLabel.frame = CGRectMake(10, 0, windowContentWidth / 8, 20);
        ...
        //
        //        UIView *line = [[UIView alloc] initWithFrame:CGRectMake(ViewX(_catLabel)+ViewWidth(_catLabel)+5, 2 , 1, ViewHeight(_catLabel) -4)];
        ...
        //  通知书
        _vc = [[UIImageView alloc]initWithFrame:CGRectMake(10, 7.5, 5, 5)];
        [_vc setImage:[UIImage imageNamed:@"椭圆-1"]];
        [lowvc addSubview:_vc];
        
        _lovlab = [[UILabel alloc]initWithFrame:CGRectMake(25, 0, 300, 20)];
        _lovlab.text = @"本订单附出团通知书";
        
        _lovlab.font = [UIFont systemFontOfSize:12];
        
        [lowvc addSubview:_lovlab];
        _buu = [[UIButton alloc]initWithFrame:CGRectMake(windowContentWidth -40, 0, 30, 20)];
        
        //[_buu setTitle:@"已读 " forState:UIControlStateNormal];
        [lowvc addSubview:_buu];
    }
...
//    if ([item.is_view integerValue]== 1 ) {
//        [_buu setTitle:@"已读 " forState:UIControlStateNormal];
//        [_buu setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
//        _buu.titleLabel.font = [UIFont systemFontOfSize:12];
//    }
//    if ([item.is_view integerValue]== 0  ) {
//        [_buu setImage:[UIImage imageNamed:@"未读"] forState:UIControlStateNormal];
//    }
    NSUserDefaults *user = [NSUserDefaults standardUserDefaults];
    if ([user boolForKey:@"已读"] == YES) {
        [_buu setTitle:@"已读 " forState:UIControlStateNormal];
        [_buu setTitleColor:[UIColor colorWithRed:87/255.0 green:93/255.0 blue:94/255.0 alpha:1.0] forState:UIControlStateNormal];
        _buu.titleLabel.font = [UIFont systemFontOfSize:12];
    } else {
        [_buu setImage:[UIImage imageNamed:@"未读"] forState:UIControlStateNormal];
    }
