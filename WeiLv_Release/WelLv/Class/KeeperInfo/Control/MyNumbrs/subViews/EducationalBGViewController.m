...
@interface EducationalBGViewController ()

@end

@implementation EducationalBGViewController
@synthesize educationalArray,uid,key,keywords;
- (void)viewDidLoad {
    [super viewDidLoad];
          ...
          forComponent:(NSInteger)component reusingView:(UIView *)view
{
    ...
    switch (component) {
        case 0:
            ret=[educationalArray objectAtIndex:row];
            break;
    }
    [lbl setText:ret];
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component {
    [btn1 setTitle:[educationalArray objectAtIndex:row] forState:UIControlStateNormal];
}
